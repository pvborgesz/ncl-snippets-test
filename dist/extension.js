...
async function saveFile(uri, text, regions) {
    /* eslint-disable */ console.log(...oo_oo(`1566354652_63_4_63_53_4`, 'Saving file with content:', regions)); // Log de salvamento de arquivo
    if (Array.isArray(regions)) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`1566354652_73_6_73_41_4`, 'Regions:', regionsAux));
      ...
      <body>
          ...
          <script>
              ...
              function sendUpdatedPositions() {
                  ...
                  const updatedNCL = updateNCLPositions(xmlDoc, regions);
