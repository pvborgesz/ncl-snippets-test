...
function startNCLScreenWebview(context) {
    ...
    panel.webview.onDidReceiveMessage(async (message) => {
        /* eslint-disable */ console.log(...oo_oo(`3774097832_40_6_40_60_4`, 'Received message from WebView:', message)); // Log recebido
...
async function saveFile(uri, text, regions) {
    /* eslint-disable */ console.log(...oo_oo(`3774097832_54_2_54_51_4`, 'Saving file with content:', regions)); // Log de salvamento de arquivo
    if (Array.isArray(regions)) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`3774097832_62_4_62_39_4`, 'Regions:', regionsAux));
